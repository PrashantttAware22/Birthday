...
$('document').ready(function () {
    ...
    $(window).resize(function () {
        ...
        if ($(window).width() <= 400) {
            ...
            $('#b11').animate({ top: 220, left: 30 }, 500);
            $('#b22').animate({ top: 220, left: 65 }, 500);
            $('#b33').animate({ top: 220, left: 120 }, 500);
            $('#b44').animate({ top: 220, left: 175 }, 500);
            $('#b55').animate({ top: 220, left: 230 }, 500);
            $('#b66').animate({ top: 220, left: 285 }, 500);
    ...
    // HAPPY BIRTHDAY BALLOON POSITION
    ...
    $('#wish_message').click(function () {
        ...
        if ($(window).width() <= 400) {
            ...
            $('#b11').animate({ top: 220, left: 10 }, 500);
            $('#b22').animate({ top: 220, left: 65 }, 500);
            $('#b33').animate({ top: 220, left: 120 }, 500);
            $('#b44').animate({ top: 220, left: 175 }, 500);
            $('#b55').animate({ top: 220, left: 230 }, 500);
